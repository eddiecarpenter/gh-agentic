...
GROUND_TRUTH: dict[str, dict[str, bool]] = {
    ...
    "solution-architecture": {
        ...
        "Update docs/ARCHITECTURE.md with the new subsystem": True,
        "Capture a new requirement": False,
        "What's the weather in Cape Town?": False,
    },
    "pr-review-session": {
        "Address PR feedback on #42": True,
        "Respond to the review on the PR": True,
        "Implement the requested changes from the reviewer": True,
        "Open a new PR": False,
        "What's the weather in Cape Town?": False,
    },
    "dev-session": {
    ...
    "feature-design": {
        ...
        "Do the design for Feature #100": True,
        "Capture a new requirement": False,
        "What's the weather in Cape Town?": False,
    },
    "trigger-implementation": {
        "Trigger implementation for #42": True,
        "Send this Feature to development": True,
        "Un-park this designed Feature and start dev": True,
        "Trigger design for this Feature": False,
        "What's the weather in Cape Town?": False,
    },
    "requirement-scoping": {
