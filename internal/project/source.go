...
//
// The signal is structural: in a consumer repo, .agents/ is a directory
...
// at "." so that any recipe or script that references .agents/.goose/…,
// .agents/skills/, .agents/standards/, etc. resolves identically in both contexts.
//
// Detection: .agents is a symlink → framework source. This is the single
